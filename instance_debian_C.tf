# Create a instance
resource "openstack_compute_instance_v2" "DebianC" {
  name        = "DebianC"
 ...
 # Install system in volume
  block_device {
    uuid                  = openstack_blockstorage_volume_v3.debian_C_volume.id
...
resource "openstack_blockstorage_volume_v3" "debian_C_volume" {
  name        = "debian_C_volume"
